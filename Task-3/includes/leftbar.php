<div class="left-sidebar bg-black-300 box-shadow ">
    <div class="sidebar-content">
        <div class="user-info closed">
            ...
            <h6 class="title">Trijal Bhardwaj</h6>
            <small class="info">Full-Stack Developer</small>
        </div>
        <!-- /.user-info -->
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        ...
                        <a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Subject Combinations</span></a>
                </li>
            </ul>
            </li>
            <li class="has-children">
            ...
            <li><a href="change-password.php"><i class="fa fa fa-server"></i> <span>Change Admin Password</span></a></li>
