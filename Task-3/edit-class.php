...
?>
    ...
    <head>
        ...
        <title>LGM SRMS Admin | Update Class</title>
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) { ?>
                                                        <div class="form-group has-success">
                                                            <label for="success" class="control-label">Class Name (In Words)</label>
                                                            <div class="">
                                                                ...
                                                                <span class="help-block">Ex- First, Second, Fourth, Eighth, Twelfth, etc</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group has-success">
                                                            <label for="success" class="control-label">Class Name (In Numerics)</label>
                                                            <div class="">
                                                                ...
                                                                <span class="help-block">Ex- 1, 2, 4, 8, 12, etc</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group has-success">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <span class="help-block">Ex- A, B, C, D, etc</span>
                                                            </div>
                                                        </div>
                                                <?php }
                                                } ?>
