...
<head>
    ...
    <title>LGM Student Result Management System (SRMS)</title>
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-12">
                                <h2 class="title" align="center">LGM Student Result Management System (SRMS)</h2>
                            </div>
                        </div>
                        <!-- /.row -->
                        <!-- /.row -->
                                                ...
                                                <table class="table table-hover table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            ...
                                                            <?php
                                                            echo htmlentities("Invalid Roll No.");
                                                        }
                                                            ?>
                                                            </div>
                                                    </tbody>
