    ...
    if (isset($_POST['submit'])) {
        ...
        foreach ($_POST['id'] as $count => $id) {
            ...
            for ($i = 0; $i <= $count; $i++) {
                ...
                $query->execute();
                $msg = "Result Information Updated Successfully";
            }
        }
    }
?>
    ...
    <head>
        ...
        <title>LGM SRMS Admin | Student Result Information</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Student Result Information</h2>
                                </div>
                                <!-- /.col-md-6 text-right -->
                            </div>
                            <!-- /.row -->
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Result Information</li>
                                    </ul>
                                </div>
                            </div>
                            <!-- /.row -->
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <h5>Update Result Information</h5>
                                            </div>
                                        </div>
